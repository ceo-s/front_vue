...
import ScheduleDay from "@/fsdcomponent/entities/DietNutrients/ui/ScheduleDay.vue";
import DietSchedule from "@/fsdcomponent/entities/DietNutrients/ui/DietSchedule.vue";
import DailyNutrients from "@/fsdcomponent/entities/DietNutrients/ui/DailyNutrients.vue";
import ManageScheduleDays from "@/fsdcomponent/features/DietNutrients/ManageScheduleDays.vue";
import ManageNutrients from "@/fsdcomponent/features/DietNutrients/ManageNutrients.vue";
export default {
  components: {
    // ChangeDayRef,
    DailyNutrients,
