...
<script>
// import { getReferenceDays } from "@/fsdcomponent/entities/Diet/api/Get";
import AddProduct from "@/fsdcomponent/features/Diet/AddProduct.vue";
import ChangeDayRef from "@/fsdcomponent/features/Diet/ChangeDayRef.vue";
import ManageDaysRef from "@/fsdcomponent/features/Diet/ManageDaysRef.vue";
import NewDayReference from "@/fsdcomponent/entities/Diet/ui/NewDayReference.vue";
import NewDietMeal from "@/fsdcomponent/entities/Diet/ui/NewDietMeal.vue";
import NewFoodAmount from "@/fsdcomponent/entities/Diet/ui/NewFoodAmount.vue";
export default {
  components: {
    AddProduct,
    ChangeDayRef,
