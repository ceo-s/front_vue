...
<script>
import { getClient } from "@/fsdcomponent/entities/Client/api/Get.js";
import ClientDemo from "@/fsdcomponent/entities/Client/ui/ClientDemo.vue";
import ClientStats from "@/fsdcomponent/entities/Client/ui/ClientStats.vue";
import BaseExercises from "@/fsdcomponent/entities/Client/ui/BaseExercises.vue";
export default {
  components: {
    ClientDemo,
    ClientStats,
